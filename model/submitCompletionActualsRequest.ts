...
export class SubmitCompletionActualsRequest {
    'deploymentId'?: string | null;
    'deploymentName'?: string | null;
    'actuals': Array<SubmitCompletionActual>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "actuals",
            "baseName": "actuals",
            "type": "Array<SubmitCompletionActual>"
        }    ];

    static getAttributeTypeMap() {
        return SubmitCompletionActualsRequest.attributeTypeMap;
    }
}
